...
import { defaultFpred } from './consts';
...
export const FuzzyPredLoad = ({ header, tag }: FuzzyProps) => {
				...
				<Box className={styles.block}>
					...
					{loadData ?
						<div className={styles.LoadContent}>
							<FileLoaderMeta name={defaultFpred} i={defaultFpred} f={defaultFpred} n="Загрузить json" />
						</div>
