...
export const FanLoad = ({ header, tag }: FuzzyProps) => {
				...
				<Box className={styles.block}>
					...
					{loadData ?
						<div className={styles.LoadContent}>
							<FileLoaderMeta name={defaultFan} i={defaultFan} f={defaultFan} n="Загрузить json" />
						</div>

						:
						<div className={styles.LoadContent}>
							<div className={styles.Prompt}>
								<p className={styles.Par}>Загрузите данные  графа.json</p>
							</div>
						</div>
					}
				</Box>
