...
# def get_file_by_hash(file_hash: str, t: str):
#     try:
#         obj = session.query(UserCacheData).filter_by(file_hash=file_hash).filter_by(operation_type=t).one()
#         return obj
#     except Exception:
#         return False
